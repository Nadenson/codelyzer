...
var FAILURE_SINGLE = 'The selector of the directive "%s" should have prefix "%s" ($$02-08$$)';
var FAILURE_MANY = 'The selector of the directive "%s" should have one of the prefixes: %s ($$02-08$$)';
