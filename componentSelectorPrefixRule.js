...
var FAILURE_SINGLE = 'The selector of the component "%s" should have prefix "%s" ($$02-07$$)';
var FAILURE_MANY = 'The selector of the component "%s" should have one of the prefixes: %s ($$02-07$$)';
